...
import "./NewCollectionsPage.scss";
...
const NewCollectionsPage: React.FC = () => {
  ...
  const fetchNewProducts = useCallback(async () => {
    try {
      ...
      // Fetch products using the API with new filter
      const response = await getProductsWithFilters({ isNew: true });
      const productsArray = normalizeProductsResponse(response);

      // Filter for new products (double check in case API doesn't filter properly)
      ...
      setError("Failed to load new products. Please try again.");
    } finally {
      setLoading(false);
    }
  }, [currentPage, sortBy]);
      ...
      <div className="page-container">
        ...
        <div className="page-header">
          <div className="breadcrumb">
            ...
            <span className="breadcrumb-current">New Collection</span>
          </div>
          <h1 className="page-title">New Collection</h1>
          <p className="page-subtitle">
            Fresh arrivals that define the future of fashion. Discover the
            latest trends and innovations in our newest collection.
          </p>
        </div>
        ...
        <div className="products-section">
          ...
          {error && (
            <div className="error-state">
              ...
              <p>{error}</p>
              <button className="btn-primary" onClick={fetchNewProducts}>
                Try Again
              </button>
            </div>
          )}
          ...
          {!loading && !error && products.length === 0 && (
            <div className="empty-state">
              ...
              <h3>No New Products Found</h3>
              <p>
                We're constantly adding new products to our collection. Check
                back soon for exciting new arrivals!
              </p>
              <button
